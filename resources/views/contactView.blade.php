...
@section("mainContent")
    ...
    <div class="container" >
        <h2>Contact</h2>
        <p>Zögern Sie nicht und kontaktieren Sie und bei Fragen</p>
        <a href="tel:{{ __('messages.shop.contact_phone') }}">
            <svg  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"class="phone_icon" >
